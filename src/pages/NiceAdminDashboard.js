...
export default function NiceAdminDashboard() {
  return (
    <>
                      ...
                      <table className="table table-borderless">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">
                              <Link to="/">
                                <img src="assets/img/product-3.jpg" alt="true" />                         </Link>
                            </th>
                            <td>
                              <Link to="/" className="text-primary fw-bold">
                          ...
                          <tr>
                            <th scope="row">
                              <Link to="/">
                                <img src="assets/img/product-4.jpg" alt="true" />                         </Link>
                            </th>
                            <td>
                              <Link to="/" className="text-primary fw-bold">
                          ...
                          <tr>
                            <th scope="row">
                              <Link to="/">
                                <img src="assets/img/product-5.jpg" alt="true" />                         </Link>
                            </th>
                            <td>
                              <Link to="/" className="text-primary fw-bold">
                ...
                <div className="card-body pb-0">
                  ...
                  <div className="news">
                    <div className="post-item clearfix">
                      <img src="assets/img/news-1.jpg" alt="true" />                 <h4>
                    ...
                    <div className="post-item clearfix">
                      <img src="assets/img/news-2.jpg" alt="true" />                 <h4>
                    ...
                    <div className="post-item clearfix">
                      <img src="assets/img/news-3.jpg" alt="true" />                 <h4>
                        <Link to="/">
                    ...
                    <div className="post-item clearfix">
                      <img src="assets/img/news-4.jpg" alt="true" />                 <h4>
                    ...
                    <div className="post-item clearfix">
                      <img src="assets/img/news-5.jpg" alt="true" />                 <h4>
                        <Link to="/">Et dolores corrupti quae illo quod dolor</Link>
                      </h4>
                      <p>
